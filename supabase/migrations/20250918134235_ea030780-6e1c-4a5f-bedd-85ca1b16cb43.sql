-- Add sample properties with valid property types
...
('Office Space Putalisadak', 'Putalisadak, Kathmandu', 45000, 'Commercial', 'rent', 'Modern office space in business district', 0, 2, 1200, ARRAY['https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800'], false, false, 0, ARRAY['Business District', 'Meeting Rooms', 'High Speed Internet']),
